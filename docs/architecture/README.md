...
For a more detailed explanation of how these components work together, see [WORKING.md](https://github.com/Kamran1819G/Perplexica/tree/master/docs/architecture/WORKING.md).
